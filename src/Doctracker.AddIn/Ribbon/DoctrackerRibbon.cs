  ...
  <ribbon>
    <tabs>
      <tab id='DoctrackerTab' label='Doctracker'>
        ...
        public bool TextSnip_GetPressed(IRibbonControl control) => Controller.IsSnipMode(SnipType.Text);
        public bool NumberSnip_GetPressed(IRibbonControl control) => Controller.IsSnipMode(SnipType.Number);
        public bool DateSnip_GetPressed(IRibbonControl control) => Controller.IsSnipMode(SnipType.Date);
        public bool SumSnip_GetPressed(IRibbonControl control) => Controller.IsSnipMode(SnipType.Sum);
        public bool TableSnip_GetPressed(IRibbonControl control) => Controller.IsSnipMode(SnipType.Table);
